  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative py-20 bg-gradient-to-b from-brand-50 to-white">
          {/* Banner de fundo */}
          <div 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-500 mt-2">Conformidade Nível AA</p>
              </div>
              <div className="text-center">
                <p className="text-4xl font-bold text-brand-600">100%</p>
                <p className="text-gray-500 mt-2">Acessível e Inclusivo</p>
              </div>
              <div className="text-center">
                <p className="text-4xl font-bold text-brand-600">FAMETRO</p>
                <p className="text-gray-500 mt-2">Projeto Acadêmico</p>
              </div>
              <div className="text-center">
                <p className="text-4xl font-bold text-brand-600">2025</p>
                <p className="text-gray-500 mt-2">Ano de Criação</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-center mb-12">Conheça a MOVER</h2>
            ...
            <Tabs defaultValue="mission" className="max-w-4xl mx-auto">
              ...
              <TabsContent value="history" className="bg-white p-6 rounded-lg shadow-sm">
                <div className="space-y-6">
              ...
              <TabsContent value="team" className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Luis Roberto Lins de Almeida</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Victor Hugo de Paula Ferreira</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Luiz Gustavo de Souza Feitosa</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Mozart Brian de Almeida Assunção</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Alan Medeiros Batista</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Vinícius da Silva Pereira</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Milena Lima Varela</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Kaiky Alex Barroso dos Santos</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Alex Victor Oliveira Cortez dos Santos</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Luiz Eduardo Martins Figueredo</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Luiz Gabriel Alves Candido da Silva</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Cauan Bastos Mendonça de Oliveira</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Marcos Vinicius Nicacio Tavares</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Isaías Emanuel Vinhote Coelho</h4>
                  </div>
                  <div className="bg-brand-50 p-4 rounded-lg text-center">
                    <h4 className="text-sm font-medium text-gray-900">Matheus Aurélio Nunes Barbosa</h4>
                  </div>
                </div>
              </TabsContent>
            </Tabs>
