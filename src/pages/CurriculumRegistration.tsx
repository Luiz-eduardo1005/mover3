      ...
      <main className="flex-grow py-10 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Cadastre seu currículo</h1>
            ...
            <CardContent>
                ...
                <div className="space-y-6">
                  <Tabs value={uploadMode} onValueChange={setUploadMode} className="w-full">
                    ...
                    <TabsContent value="form" className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          <Label htmlFor="profession">Profissão/Cargo atual</Label>
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="portfolio">Portfólio ou site pessoal (opcional)</Label>
                        <Input id="portfolio" />
                      </div>
                    </TabsContent>
                    ...
                    <TabsContent value="upload">
                      <div className="py-8 border-2 border-dashed border-gray-300 rounded-md text-center">
                        ...
                        <h3 className="text-lg font-medium mb-2">Arraste seu currículo ou clique para selecionar</h3>
                        <p className="text-sm text-gray-500 mb-4">Suporte para PDF, DOCX ou TXT (máx. 5MB)</p>
                ...
                <div className="space-y-6">
                  <div className="bg-gray-50 border rounded-md p-4">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">Jan 2022 - Atual</p>
                      </div>
                  ...
                  <Card className="border border-dashed bg-gray-50">
                    <CardContent className="p-4">
                      <h3 className="font-medium mb-4">Adicionar experiência</h3>
              ...
              {step === 3 && (
                <div className="space-y-6">
                  <div className="bg-gray-50 border rounded-md p-4">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        ...
                        <p className="text-gray-600">Universidade Estadual de Campinas</p>
                  ...
                  <Card className="border border-dashed bg-gray-50">
                    <CardContent className="p-4">
                      <h3 className="font-medium mb-4">Adicionar formação</h3>
                  ...
                  <div className="pt-4 pb-2">
                    <h3 className="font-medium mb-4">Cursos e certificações</h3>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center bg-gray-50 border rounded-md p-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">Amazon Web Services, 2023</p>
                        </div>
                        <Button variant="ghost" size="sm">
                          <X className="h-4 w-4" />
                        </Button>
              ...
              {step === 4 && (
                <div className="space-y-8">
                  <div>
                    <h3 className="font-medium mb-4">Habilidades profissionais</h3>
                  ...
                  <div>
                    <h3 className="font-medium mb-4">Idiomas</h3>
                    ...
                    <Card className="border border-dashed bg-gray-50">
                      <CardContent className="p-4">
                        <h4 className="font-medium mb-4">Adicionar idioma</h4>
              ...
              {step === 5 && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="font-medium">Preferências de trabalho</h3>
                  ...
                  <div className="space-y-4">
                    <h3 className="font-medium">Visibilidade do currículo</h3>
                    
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium">Currículo visível para recrutadores</p>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium">Receber alertas de vagas</p>
                        <p className="text-sm text-gray-500">
